...
// mudar numero maximo dps, é apenas para teste
...
/*void salvar(Aluno *lista_aluno, int qtd_aluno) {
  FILE *arq;
  arq = fopen("EscolaAluno.txt", "w+");
  for (int i = 0; i < qtd_aluno; i++) {
    //fputs(lista_aluno[i].matricula, arq); printf("\n");
  }
  fclose(arq);
}*/
...
// int CarregarDisciplina(Disciplina *lista) {
//   int qtd_disciplina = 0;
//   FILE *arq_disciplina;
//   const int LINE_MAX_SIZE = 500;
//   arq_disciplina = fopen("EscolaDisciplina.txt", "r");
...
//   char *slice;
//   int sum = 0;
//   while (fgets(line, LINE_MAX_SIZE, arq_disciplina) != NULL) {
//     // printf("%s", line);
//     slice = strtok(line, separator);
//     int i = 0;
//     while (slice != NULL) {
//       if (i == 0)
//         lista[qtd_disciplina].TAM_ALUNO_POR_DISCIPLIA = atoi(slice);
//       else if (i == 1)
//         lista[qtd_disciplina].ativo = atoi(slice);
//       else if (i == 2)
//         lista[qtd_disciplina].semestre = atoi(slice);
//       else if (i == 3)
//         lista[qtd_disciplina].codigo = atoi(slice);
//       else if (i == 4)
//         lista[qtd_disciplina].qtd_aluno = atoi(slice);
//       else if (i == 5)
//         strcpy(lista[qtd_disciplina].nome, slice);
//       else if (i == 6)
//         strcpy(lista[qtd_disciplina].professor, slice);
//       else if (i >= 7)
//         lista[qtd_disciplina].alunos[i - 7] = atoi(slice);
//       i++;
//     }
//     qtd_disciplina++;
//   }
